...
class NiveisRadiacaoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_niveis_radiacao)
        ...
        val pressaoRecyclerView: RecyclerView = findViewById(R.id.radiationRecyclerView)
        ...
        lifecycleScope.launch {
            try {
                ...
                val response = withContext(Dispatchers.IO) {
                    ApiClient.apiService.getHorarios() // Chamada suspensa
                }
