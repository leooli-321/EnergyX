...
class PressaoReatorActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_pressao_reator)
        ...
        val pressaoRecyclerView: RecyclerView = findViewById(R.id.pressureRecyclerView)
    ...
    private fun getHorariosFromApi() {
        lifecycleScope.launch {
            try {
                // Chama a API em um thread de background
